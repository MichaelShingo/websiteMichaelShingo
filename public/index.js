...
if (page == 'violinist' || page == 'hire-a-violinist-in-netherlands' || page == 'wedding-violinist-in-the-netherlands'){
    ...
    reviewList = [
        {stars: 5, date: 'July 1, 2023', name: 'Jamie C.', title:'Piano In Studio/Online', review: 'I always enjoyed my lessons with Michael as my piano teacher. He was incredible patience with me as an adult student learning an instrument for the first time. He focused on technique as well as making time to learn some fun songs. He would help explain complicated music theory, and gave me helpful tricks & habits when reading music. Overall, I was very happy with my time as his student, and am grateful he helped me pursue a new hobby.'},
        {stars: 5, date: 'June 24, 2023', name: 'Weilun Q.', title:'Violin In Studio', review: 'Michael is very patient and a very skilled violin player. He is always on time and shows up well prepared for the lessons. He also helped tailor the lesson plans to my personal interests and progress. I would definitely recommend him.'},
        {stars: 5, date: 'June 20, 2023', name: 'Jonathan P.', title:'Violin In Studio', review: 'Besides being a highly capable teacher, Michael is clearly an impassioned musician who dedicates much of his life to the craft.Michael is patient, kind, receptive, and punctual, and is an invaluable resource for students of all experience levels.'},
        {stars: 5, date: 'June 24, 2023', name: 'Sarah W.', title:'Violin In Studio/Online', review: 'I have a young daughter that was interested in violin. We started with Mr.Michael the week before the covid shutdown so we had to began online lessons instead. Mr.Michael is amazing in teaching the basics and working with us parents (who are not musically inclined) to understand and begin music lessons. She loves playing and looks forward to every session. Mr Michael is patient and kind. He encourages her, gives great feedback and goals. I highly recommend him for a beginner he will help them discover a love for it!'},
        {stars: 5, date: 'June 23, 2023', name: 'Addison S.', title:'Violin In Studio', review: 'Amazing teacher! Very patient and helpful!'},
        {stars: 5, date: 'June 19, 2023', name: 'Jeff M.', title:'Piano In Studio/Online', review: 'My daughter learned a lot in the year+ of piano lessons with Michael. He is a patient and kind instructor. She was able to apply her understanding of music as she learned other instruments as well.'},
        {stars: 5, date: 'November 18, 2021', name: 'Bruce R.', title:'Violin In Studio/Online', review: 'Michael is so patient (& talented). Very knowledgeable and calm demeanor. Looking forward to more lessons.'},
        {stars: 5, date: 'November 28, 2020', name: 'Ben P.', title:'Violin Online', review: 'Having met Michael through a mutual friend, I started lessons with him earlier this year. As a composer, I had recently purchased a violin to become a better orchestrator and thought I might progress quicker if I took lessons. These lessons soon turned into orchestration lessons where we went through my parts, and Michael told me what I could do to make my string writing better. Overall, he is extremely knowledgeable and helpful.'},
        {stars: 5, date: 'November 26, 2020', name: 'Tom G.', title:'Violin In Studio/Online', review: 'Michael has been instructing my 2nd grade son in violin for the past year. Thomas has seen great improvements in his violin ability and Michael is a patient teacher able to work with children. Michaels gentle instruction will push your childs abilities and improve their musicianship. Each lesson usually introduces new challenges to master, or improvement on previously learned skills and music compositions. I highly recommend Michael if your child is interested in learning violin.'},
